...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("Tolong tunggu...!", quote = True)
    try:
        ...
        print(e)
        await reply_text.edit_text("Sepertinya ada yang salah..!")
        return
    ...
    await reply_text.edit("SILAHKAN CEK TOMBOL DI BAWAH", reply_markup=reply_markup, disable_web_page_preview = True)
